          ...
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              {relatedProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all cursor-pointer"
                >
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2 text-center">{product.name}</h4>
